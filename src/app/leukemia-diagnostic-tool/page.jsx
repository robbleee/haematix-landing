...
export const metadata = {
  title: 'Leukemia Decision Support Tool',
  description:
    'Haem.io is clinician-facing leukemia classification decision support for AML and MDS criteria review, designed for transparent guideline-aligned execution.',
  alternates: {
    ...
    <section style={{ backgroundColor: '#f8fafc', minHeight: '100vh', padding: '4rem 1.25rem' }}>
      <div style={{ maxWidth: '980px', margin: '0 auto' }}>
        <h1 style={{ fontSize: '2.5rem', marginBottom: '1rem', color: '#0f172a' }}>
          Leukemia Decision Support for Clinical Teams
        </h1>
        <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#334155', marginBottom: '1.25rem' }}>
          Haem.io (Haemio) is a hematology decision-support platform built to help teams review high-complexity leukemia and myeloid disease classification criteria. It combines deterministic algorithmic execution with explainable, clinician-verifiable logic.
        </p>
        ...
        <ul style={{ color: '#334155', lineHeight: '1.9', marginBottom: '2rem' }}>
          ...
          <li>Traceable criteria paths for every classification support output</li>
          <li>Human-in-the-loop workflow: clinicians verify inputs and retain final judgement</li>
        </ul>
