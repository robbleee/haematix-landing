...
export const metadata = {
  title: 'MDS vs AML Classification Review',
  description:
    'Understand key differences between MDS and AML classification review, including blast thresholds, genomic context, and guideline-driven criteria logic.',
  alternates: {
    ...
    <section style={{ backgroundColor: '#ffffff', minHeight: '100vh', padding: '4rem 1.25rem' }}>
      <div style={{ maxWidth: '980px', margin: '0 auto' }}>
        <h1 style={{ fontSize: '2.5rem', marginBottom: '1rem', color: '#0f172a' }}>
          MDS vs AML Classification Review in Genomic-Era Hematology
        </h1>
        ...
        <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#334155', marginBottom: '2rem' }}>
          Haem.io is designed to execute this criteria logic consistently while preserving traceability to specific rules in WHO 2022 and ICC 2022 frameworks.
        </p>
        ...
        <ul style={{ color: '#334155', lineHeight: '1.9', marginBottom: '2rem' }}>
          <li>Borderline presentations can affect downstream clinical review and risk framing.</li>
